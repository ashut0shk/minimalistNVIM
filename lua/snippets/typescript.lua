...
return {
  ...
  {
    trigger = 'func',
    body = 'function ${1:function_name}(${2:args}): ${3:void} {\n\t${4:// body}\n$0\n}',
    preview = '**function** `function_name`(args): **void** {\n\t// body\n}',
  },
  ...
  -- interface definition
  {
    ...
    preview = '**interface** `InterfaceName` {\n\tproperty: type;\n}',
  },
  ...
  {
    trigger = 'async',
    body = 'async function ${1:function_name}(${2:args}): Promise<${3:ReturnType}> {\n\t${4:// body}\n$0\n}',
    preview = '**async function** `function_name`(args): **Promise<ReturnType>** {\n\t// body\n}',
  },
